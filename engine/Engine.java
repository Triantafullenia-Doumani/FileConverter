...
public class Engine implements IPlainTextDocumentEngine {
	...
	public Engine(String pFilePath, String pInputType, String pAlias) {
		...
		if (pInputType.equals("ANNOTATED"))
		{
	 ...
	 */
	@Override
	public int exportPdf(String outputFileName) throws FileNotFoundException, DocumentException {
		if(this.lineblocks.size() == 0) {
			loadFileAndCharacterizeBlocks();
		}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private int loadRawDocument(String filePath2) {
		RawFileLineLoader loader = new RawFileLineLoader();
		this.lineblocks = loader.load(this.filePath); 
		this.document.addLineBlocks(lineblocks);
		...
		for(LineBlock l: lineblocks) {
			...
			for(String prefix: prefixes) {
				if(l.startsWith(prefix)) {
					String newString = l.replaceFirst(prefix, "");
