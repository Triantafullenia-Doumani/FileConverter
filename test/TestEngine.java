...
public class TestEngine {
	...
	private static IPlainTextDocumentEngine engine1;
	private static IPlainTextDocumentEngine engine2;	
...
//	}
	...
	//@author TD 
	private static String setupProfile_HTLM() {
		inputSpec = new ArrayList<List<String>>();
		h1List = new ArrayList<String>(); inputSpec.add(h1List);
		h1List.add("H1");h1List.add("STARTS_WITH"); h1List.add("<H1>");
		
		boldList = new ArrayList<String>(); inputSpec.add(boldList);
		boldList.add("<B>");boldList.add("STARTS_WITH"); boldList.add("<H2>");
	...
	private static String setupProfile_TXT() {
		inputSpec = new ArrayList<List<String>>();
		h1List = new ArrayList<String>(); inputSpec.add(h1List);
		h1List.add("H1");h1List.add("STARTS_WITH"); h1List.add("OATH");
		
		boldList = new ArrayList<String>(); inputSpec.add(boldList);
		boldList.add("<B>");boldList.add("STARTS_WITH"); boldList.add("INTRODUCTORY ");
	...
	//pdf are same but return is false
	@Test
	public final void testLoadProcessWritePdfHippo() throws FileNotFoundException, DocumentException {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileName, "RAW", "happyhippo");
		setupProfileHippo();
		engine.registerInputRuleSetForPlainFiles(inputSpec);
	...
	@Test
	public final void testLoadProcessWritePdfEconomy() throws FileNotFoundException, DocumentException {
		String inputFileName = "Resources/SampleDocs/economy_mt.txt";
		engine = new Engine(inputFileName, "RAW", "economy");
		setupProfileEcon();
		engine.registerInputRuleSetForPlainFiles(inputSpec);
...
//////////////////////// TESTS @author TD  //////////////////////////////////////////	
	...
	public final void testLoadFile() {
		String inputFileNameHTML = "Resources/SampleDocs/hippocratesOath.html";
		engine = new Engine(inputFileNameHTML, "ANNOTATED", "happyhippoHTML");
		int lineblocksSize = engine.loadFileAndCharacterizeBlocks();
		System.out.println("-------------------------------------------------------------------------------");
		assertEquals(17,lineblocksSize);
	}
	@Test
	public final void testLoadRules() {
		RuleSet ruleSet;
		String inputFileNameHTML = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileNameHTML, "RAW", "happyhippoHTML");
		setupProfileHippo();
		ruleSet = engine.registerInputRuleSetForPlainFiles(inputSpec);
		System.out.println("-------------------------------------------------------------------------------");
		assertNotNull(ruleSet);
		
	}
	@Test
	public final void testAskForReport() {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileName, "RAW", "happyhippo");
		setupProfileHippo();
		engine.registerInputRuleSetForPlainFiles(inputSpec);
	...
	@Test
	public final void testExportToAnotherForm() throws FileNotFoundException, DocumentException {
		String inputFileName = "Resources/SampleDocs/hippocratesOath.txt";
		engine = new Engine(inputFileName, "RAW", "happyhippo");
		setupProfileHippo();
		engine.registerInputRuleSetForPlainFiles(inputSpec);
	...
	@Test
	public final void testLoadProcessWriteHippoHtmlTxt() {
	String inputFileNameHTML = "Resources/SampleDocs/hippocratesOath.html";
	engine1 = new Engine(inputFileNameHTML, "ANNOTATED", "happyhippoHTML");
	setupProfile_HTLM();
	List<String> prefixes = new ArrayList<String>(); 
	prefixes.add("<H1>");prefixes.add("<H2>");prefixes.add("<i>");prefixes.add("<b>");prefixes.add("<p>");
	engine1.registerInputRuleSetForAnnotatedFiles(inputSpec, prefixes);

	String outputFileNameHTLM = "Resources//Outputs//hippocratesOathHTML.md";
	int lineblocks1 = engine1.exportMarkDown(outputFileNameHTLM);
	File outputFileHTML = new File("Resources//Outputs//hippocratesOathHTML.md");
//////////
	String inputFileNameTXT = "Resources/SampleDocs/hippocratesOath.txt";
	engine2 = new Engine(inputFileNameTXT, "RAW", "happyhippoTXT");
	setupProfile_TXT();
	engine2.registerInputRuleSetForPlainFiles(inputSpec);

	String outputFileNameTXT = "Resources//Outputs//hippocratesOathTXT.md";
	int lineblocks2 = engine2.exportMarkDown(outputFileNameTXT);
	File outputFileTXT = new File("Resources//Outputs//hippocratesOathTXT.md");

	assertEquals(lineblocks1,lineblocks2);
	System.out.println("-------------------------------------------------------------------------------");

	Boolean localComparison = compareFiles(outputFileTXT, outputFileHTML, "testLoadProcessWriteMarkupHippo()");
	assertEquals(true, localComparison);
